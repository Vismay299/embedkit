  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose text-gray-700 space-y-4">
        ...
        <p>By accessing and using EmbedKit, you agree to be bound by these Terms and Conditions.</p>
        ...
        <p>For questions about these terms, contact us at support@embedkit.co.</p>
      </div>
    </div>
  );
}
